...
export interface ApiCastCast extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isReception: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    castCustomID: Schema.Attribute.String;
...
export interface ApiScheduleSchedule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isFullyBooked: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    casts: Schema.Attribute.Relation<'oneToMany', 'api::cast.cast'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
